  ...
  return (
    <>
      ...
      <Link
        ...
        className="fixed top-6 right-6 z-50 text-sm font-overusedGrotesk px-5 py-2.5 rounded-full bg-[#ff5941] text-white hover:bg-[#ff5941]/90 transition-colors duration-200 shadow-sm"
      >
        Contact Me
      </Link>
    </>
